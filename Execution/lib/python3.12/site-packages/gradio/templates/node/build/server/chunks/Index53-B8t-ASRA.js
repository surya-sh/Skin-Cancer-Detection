...
import { B as Block, S as Static, f as BlockLabel, y as File$1, h as Empty, U as UploadText, i as IconButtonWrapper, j as IconButton, J as Undo, k as Download } from './2-apuiq8R9.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-nO8I645B.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-LoOIMq0F.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-D4Cqif21.js');
  return module.default;
}
...
//# sourceMappingURL=Index53-B8t-ASRA.js.map
