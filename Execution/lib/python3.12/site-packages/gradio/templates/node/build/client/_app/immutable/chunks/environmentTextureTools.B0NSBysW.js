const __vite__fileDeps=["./rgbdDecode.fragment.rwq24wBt.js","./index.Bq5mFuDo.js","./preload-helper.DpQnamwV.js","./helperFunctions.COqGwMB7.js","./rgbdDecode.fragment.hUWhAROE.js","./helperFunctions.GtpVj9KP.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { _ as __vitePreload } from "./preload-helper.DpQnamwV.js";
import { h as Logger, I as InternalTexture, B as BaseTexture, b as Tools, ag as ILog2, ah as PostProcess, ai as SphericalPolynomial, V as Vector3 } from "./index.Bq5mFuDo.js";
import "./dumpTools.DN0ziOG5.js";
...
async function _UploadLevelsAsync(texture, imageData, canGenerateNonLODTextures, imageType = DefaultEnvironmentTextureImageType) {
  ...
  if (expandTexture) {
    if (engine.isWebGPU) {
      shaderLanguage = 1;
      await __vitePreload(() => import("./rgbdDecode.fragment.rwq24wBt.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0, import.meta.url);
    } else {
      await __vitePreload(() => import("./rgbdDecode.fragment.hUWhAROE.js"), true ? __vite__mapDeps([4,1,2,5]) : void 0, import.meta.url);
    }
