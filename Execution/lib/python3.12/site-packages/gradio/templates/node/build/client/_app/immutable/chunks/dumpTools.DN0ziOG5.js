const __vite__fileDeps=["./index.Bq5mFuDo.js","./preload-helper.DpQnamwV.js","./pass.fragment.D6kmqAtj.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { _ as __vitePreload } from "./preload-helper.DpQnamwV.js";
import { aj as Clamp, b as Tools, ak as EngineStore, al as EffectRenderer, am as EffectWrapper } from "./index.Bq5mFuDo.js";
...
async function _CreateDumpRenderer() {
  if (!_enginePromise) {
    _enginePromise = new Promise((resolve, reject) => {
      ...
      __vitePreload(() => import("./index.Bq5mFuDo.js").then((n) => n.bW), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then(({ ThinEngine: thinEngineClass }) => {
        var _a;
        ...
        __vitePreload(() => import("./pass.fragment.D6kmqAtj.js"), true ? __vite__mapDeps([2,0,1]) : void 0, import.meta.url).then(({ passPixelShader }) => {
          if (!engine) {
