...
const name$h = "prePassDeclaration";
...
const name$g = "oitDeclaration";
const shader$g = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
const name$f = "decalFragmentDeclaration";
const shader$f = `#ifdef DECAL
...
const name$e = "lightFragmentDeclaration";
...
const name$d = "lightUboDeclaration";
...
const name$c = "samplerFragmentDeclaration";
const shader$c = `#ifdef _DEFINENAME_
...
const name$b = "imageProcessingDeclaration";
const shader$b = `#ifdef EXPOSURE
...
const name$a = "imageProcessingFunctions";
const shader$a = `#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
const name$9 = "shadowsFragmentFunctions";
const shader$9 = `#ifdef SHADOWS
...
const name$8 = "ltcHelperFunctions";
const shader$8 = `vec2 LTCUv( const in vec3 N,const in vec3 V,const in float roughness ) {const float LUTSIZE=64.0;const float LUTSCALE=( LUTSIZE-1.0 )/LUTSIZE;const float LUTBIAS=0.5/LUTSIZE;float dotNV=saturate( dot( N,V ) );vec2 uv=vec2( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
