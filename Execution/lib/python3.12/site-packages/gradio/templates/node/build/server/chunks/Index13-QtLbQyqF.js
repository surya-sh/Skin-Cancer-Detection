...
import { B as Block, S as Static, f as BlockLabel, Q as Code$2, h as Empty, j as IconButton, z as Copy$1, D as DownloadLink, k as Download$1, i as IconButtonWrapper, V as getWorkerProxyContext } from './2-apuiq8R9.js';
...
const lang_map = {
  python: () => import('./index29-D01KDB29.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index30-qiP1X5L1.js'),
      import('./frontmatter-DzG3fdNH.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index34-Cljxd7g5.js').then((m) => m.json()),
  html: () => import('./index31-Cwngeyt7.js').then((m) => m.html()),
  css: () => import('./index32--fRQdcFU.js').then((m) => m.css()),
  javascript: () => import('./index33-BOtzTAsc.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index33-BOtzTAsc.js').then(
...
//# sourceMappingURL=Index13-QtLbQyqF.js.map
